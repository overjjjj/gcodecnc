...
int main(int argc, char **argv)
{
    ...
    const QList<QPair<QByteArray, QString>> rejectedDocuments{
        ...
        {WithArrayObjectValue(QStringLiteral("deepHoleStageParameters"),
                              QStringLiteral("guideEnabled"), true),
         QStringLiteral("reference semantics")},
        {WithArrayObjectValue(QStringLiteral("deepHoleStageParameters"),
                              QStringLiteral("slowEntryEnabled"), true),
         QStringLiteral("reference semantics")},
        {WithArrayObjectValue(QStringLiteral("deepHoleStageParameters"),
                              QStringLiteral("breakthroughEnabled"), true),
         QStringLiteral("reference semantics")},
        {WithArrayObjectValue(QStringLiteral("deepHoleStageParameters"),
                              QStringLiteral("transitionEnabled"), true),
         QStringLiteral("reference semantics")},
        {WithArrayObjectValue(QStringLiteral("deepHoleStageParameters"),
